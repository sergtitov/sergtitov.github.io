...
$(document).ready(function() {
    ...
    Parse.initialize("wB2IXjFuj0XvcgyLRCOYh2WxAOWLyw3Nge6YHHcL", "sdLiw7TWw6YX6myFhjaENLeV3rUJDajGwDw4Iux0");
    ...
    $('#contactform').submit( function(event) {
        ...
        var showResponse = function (text, status) {
            var delay= 1300;
            $('#contactform').delay(delay).slideUp('fast');
            //$('#response').html(text).addClass(status).hide().delay(delay).slideDown('fast')
            $('#response').html(text).hide().delay(delay).slideDown('fast')
        };
